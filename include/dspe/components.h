...
struct SleepState {
    ...
    static constexpr uint32_t SLEEP_TICKS = 30; // 0.5s at 60Hz
    static const FpVel LINEAR_THRESHOLD;
    static const FpVel ANGULAR_THRESHOLD;
    static const FpPos WAKE_RADIUS;
};

const FpVel SleepState::LINEAR_THRESHOLD  = FpVel::from_float(0.01f);
const FpVel SleepState::ANGULAR_THRESHOLD = FpVel::from_float(0.01f);
const FpPos SleepState::WAKE_RADIUS       = FpPos::from_float(1.0f);
